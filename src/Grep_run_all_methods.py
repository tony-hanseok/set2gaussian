...
gene_set_file = '/home/tony/gits/set2gaussian/data/0.7/cpdb_node_set.txt'
network_file = '/home/tony/gits/set2gaussian/data/0.7/network.txt'
...
Path_RWR, log_Path_RWR, log_node_RWR, train_ind, test_ind, Path_mat_train, _, p2i = create_matrix(Node_RWR, Net_obj, para_dict['p_train'], gene_set_file)
...
save_embedding(p2g, path_mu, path_cov, Grep_node_emb, p2i, output_file=output_emb_file)
